...
<!-- MODAL EDIT -->
<div class="modal fade" id="ModalaEdit" aria-hidden="true">
            ...
            <form class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="keterangan_edit" id="keterangan" class="form-control" type="textarea" placeholder="Keterangan" required>
                        </div>
                    </div>
